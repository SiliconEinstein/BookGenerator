...
def create_app() -> FastAPI:
    ...
    # 添加PPT生成路由（v3版本，基于 Claude CLI + html-ppt skill）
    from .routes.ppt_v3 import router as ppt_v3_router
    app.include_router(ppt_v3_router, prefix="/v1")
